...
class Connect extends PDO{
    public function __construct(){
        parent::__construct("mysql:host=localhost;dbname=barbershop", 'root', '',
...
class Controller {
    ...
    function insertData($data){
        ...
        if(!$info["id"]){
            ...
            $insertNewUser = $db -> prepare("INSERT INTO users (f_name, l_name, email, password, session) VALUES (:f_name, :l_name, :email, :password, :session)");
