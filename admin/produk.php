...
<table class="table table-bordered mt-4">
	<thead>
  <a href="tambahproduk.php" class="btn btn-primary mt-4">Tambah Data Produk</a>
		<tr>
	...
	<tbody>
		...
		<?php $no=1; ?>
		<?php $ambil = $con->query("SELECT * FROM produk LEFT JOIN kategori ON produk.id_kategori=kategori.id_kategori") ?>
		<?php while($pecah = $ambil->fetch_assoc()): ?>
		<tr>
			<td class="text-center"><?= $no; ?></td>
			<td class="text-center"><?= $pecah["nama_produk"]; ?></td>
			<td class="text-center"><?= $pecah['nama_kategori']; ?></td>
			<td class="text-center">Rp. <?= number_format($pecah["harga_produk"]); ?>,-</td>
			<td class="text-center"><?= $pecah["berat_produk"]; ?></td>
			<td class="text-center">
				<img src="../foto_produk/<?= $pecah["foto_produk"]; ?>" width="75" height="65">
			</td>
			<td class="text-center"><?= $pecah['stok_produk']; ?></td>
			<td class="text-center">
				<a href="produk.php?halaman=ubahproduk&id=<?= $pecah['id_produk']; ?>" class="btn btn-secondary btn-xs"><i class="bi bi-pencil-square"></i></a>  
				<a href="produk.php?halaman=detailproduk&id=<?= $pecah['id_produk']; ?>" class="btn btn-info btn-xs"><i class="bi bi-arrow-down-right-circle"></i></a> 
				<a href="produk.php?halaman=hapusproduk&id=<?= $pecah['id_produk']; ?>" onclick="return confirm('Yakin akan menghapus data?')" class="btn btn-danger btn-xs"><i class="bi bi-trash"></i></a>
			</td>
		</tr>
		<?php $no++; ?>
		<?php endwhile; ?>
