  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Data Kategori</h6>
        </nav>
	...
	<div class="section">
		<div class="container">
			...
			<div class="box">
				<p><a class="btn btn-primary" href="print2.php"><i class="bi bi-printer-fill me-2"></i>Print</a></p>
				<p><a class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#exampleModal" ><i class="bi bi-plus-circle me-2"></i>Tambah Data</a></p>
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td align="center">
								<a href="edit-kategori.php?id=<?php echo $row['category_id'] ?>"><i class="bi bi-pen-fill me-2"></i></a><a href="hapus.php?idk=<?php echo $row['category_id'] ?>" onclick="return confirm('Yakin ingin hapus ?')"><i class="bi bi-trash-fill ms-2"></i></a>
							</td>
						</tr>
						<?php }}else{ ?>
							<tr>
