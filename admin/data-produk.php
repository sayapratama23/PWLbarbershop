...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="card-body">
        ...
        <?php
							$no = 1;
							$produk = mysqli_query($con, "SELECT * FROM barang ORDER BY br_id DESC");
						...
						<tr>
							...
							<td>Rp. <?php echo number_format($row['br_hrg']) ?></td>
							<td><a href="<?php echo $row['br_gbr'] ?>" target="_blank"> <img src="<?php echo $row['br_gbr'] ?>" width="50px" height="40px"> </a></td>
							<td><?php echo ($row['br_sts'] == 0)? 'Y':'N'; ?></td>
							<td>
								<a href="edit-produk.php?id=<?php echo $row['br_id'] ?>">Edit</a> || <a href="proses-hapus.php?idp=<?php echo $row['br_id'] ?>" onclick="return confirm('Yakin ingin hapus ?')">Hapus</a>
							</td>
						</tr>
						<?php }}else{ ?>
							<tr>
