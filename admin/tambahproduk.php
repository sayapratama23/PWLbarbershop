...
if(isset($_POST["submit"])){
	...
	$result = $con->query("INSERT INTO produk VALUES('', '$_POST[id_kategori]', '$_POST[nama]', '$_POST[harga]', '$_POST[berat]', '$namanamafoto[0]', '$_POST[deskripsi]', '$_POST[stok]')");

	// Mendapatkan id_produk barusan
	$id_produk_barusan = $con->insert_id;
	...
	foreach($namanamafoto as $key => $tiap_nama){
		...
		$hasil = $con->query("INSERT INTO 	produk_foto(id_produk, nama_produk_foto) VALUES('$id_produk_barusan','$tiap_nama')");
	}
