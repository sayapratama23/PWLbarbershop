          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="row">
                ...
                <div class="col-6 text-end">
                    <a class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" data-bs-target="#exampleModal" href="form-daftar.php"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Produk</a>
                </div>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive">
                ...
                <section class="baris">
                  <div class="kolom kolom1">Produk 1</div>
                  <div class="kolom kolom2">Produk 2</div>
                  <div class="kolom kolom3">Produk 3</div>        
              </section>
                </table>
              </div>
            </div>
