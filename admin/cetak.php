...
<body style="padding: 50px;" onload="window.print();">
  <?php
    $no = 1;
    $cari=mysqli_query($con, "SELECT * from tb_product") or die (mysqli_error());

   
    ?>
    <h4 class="text-center">Laporan Barang</h4>
    <table width="800" cellpadding="4" cellspacing="0" class="table table-light  col-lg-10 mt-4">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <td align="center"><?php echo $data['data_created']; ?></td>
