  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <form action="proses-edit.php" method="POST">
            ...
            <div class="form-group col-lg-8">
                  ...
                  <input type="text" name="alamat" class="form-control" placeholder="Masukkan alamat" value="<?php echo $pelanggan['alamat'] ?>" />
            </div>
            <div class="form-group col-lg-8">
                  <label for="tagihan">Tagihan</label>
                  <input type="text" name="tagihan" class="form-control" placeholder="Masukkan tagihan" value="<?php echo $pelanggan['tagihan'] ?>" />
            </div>
