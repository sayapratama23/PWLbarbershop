...
if(isset($_POST['login'])){
  ...
  $ambil = $con->query("SELECT * FROM pelanggan WHERE email_pelanggan='$email' AND telepon_pelanggan='$telepon'");
...
<head>
  ...
  <title>Konfirmasi Pelanggan</title>
    ...
    <div class="col-md-4 col-md-offset-4">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Konfirmasi Pelanggan</h3>
        </div>
